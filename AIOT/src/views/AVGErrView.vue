...
const getData = () => {
    axios({
        ...
        params: {
            startTime: strtime.value, endTime: endtime.value, item: item.value, product: product.value, line: line.value, type: type.value, device: deviceName.value, avg: 'avg'
        }
    }).then((res) => {
        arrDate.value = [];
        arrAVGCount.value = [];
            ...
            plugins: {
                datalabels: {
                    ...
                    color: function (context) {
                        debugger;
                        if (context.dataset.meta === undefined || parseFloat(context.dataset.data[context.dataIndex]) <= context.dataset.meta.targetValue) {
...
<template>
    <div style="display: flex; flex-direction: column;justify-content: center; align-items: center;">
        ...
        <div>
            <avgErrChart id="avgErrChart" :key="componentKey" :data="avgErrChartData" :options="avgErrChartOptions" />
        </div>
    </div>
</template>
<style scoped>
